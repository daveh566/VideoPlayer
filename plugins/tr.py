...
START_TEXT = '👋 `HEYA I'M` **NellyXVcPlayer** \n\n` Enjoy your streaming [Owner](https://t.me/aspirer2)`'
ABOUT_TEXT = '**INFORMATION** \n\n`🤖  I stream videos in telegram group video chats using several methods from WebRTC.` \n\n`💡 Powered by PyTgcalls the Async client API for the Telegram Group Calls, and Pyrogram the telegram MTProto API Client Library and Framework in Pure Python for Users and Bots.` \n\n**I'm licensed under GNU-GPL 3.0 License**'
